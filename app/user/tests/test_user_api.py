...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@gmail.com', 'password': 'testpass8'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        ...
        payload = {'email': 'test@gamil.com', 'password': 'pw'}
        res = self.client.post(CREATE_USER_URL, payload)
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test@gamil.com', 'password': 'testpass9'}
        create_user(**payload)
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='test@gmail.com', password='testpass10')
    ...
    def test_creat_token_no_user(self):
        ...
        payload = {'email': 'test@gmail.com', 'password': 'testpass11'}
        res = self.client.post(TOKEN_URL, payload)
